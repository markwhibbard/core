...
async def test_get_triggers(hass, device_reg, entity_reg):
    """Test we get the expected triggers from a mwh_trigger."""
...
async def test_if_fires_on_state_change(hass, calls):
    ...
    hass.states.async_set("mwh_trigger.entity", STATE_OFF)
    ...
    hass.states.async_set("mwh_trigger.entity", STATE_ON)
